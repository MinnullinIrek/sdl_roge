...
-   SDL3_main should be used to ensure ROMFS is enabled - this is done with `#include "../vendor/SDL/include/SDL3/SDL_main.h"` in the source file that contains your main function.
