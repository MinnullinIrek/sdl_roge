...
#include <../vendor/SDL/include/SDL3/SDL_events.h>
        ...
        /* On WinRT, SDL provides a main function that initializes CoreApplication,
           ...
           otherwise empty .cpp file that only contains `#include "../vendor/SDL/include/SDL3/SDL_main.h"`
...
#include <../vendor/SDL/include/SDL3/SDL_init.h>
...
#include <../vendor/SDL/include/SDL3/SDL_close_code.h>
    ...
    /* include header-only SDL_main implementations */
        ...
        #include <../vendor/SDL/include/SDL3/SDL_main_impl.h>
        ...
        #include <../vendor/SDL/include/SDL3/SDL_main_impl.h>
             ...
             */
            #ifdef _MSC_VER
                #pragma message("Note: Your platform needs the SDL_main implementation in a C++ source file. You can keep your main() in plain C (then continue including SDL_main.h there!) and create a fresh .cpp file that only contains #include "../vendor/SDL/include/SDL3/SDL_main.h"")
            #elif defined(__GNUC__) /* gcc, clang, mingw and compatible are matched by this and have #warning */
                #warning "Note: Your platform needs the SDL_main implementation in a C++ source file. You can keep your main() in plain C and create a fresh .cpp file that only contains #include "../vendor/SDL/include/SDL3/SDL_main.h""
            #endif /* __GNUC__ */
        #endif /* __cplusplus */
