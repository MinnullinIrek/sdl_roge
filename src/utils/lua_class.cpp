...
//  public:
//   int t = 0;
//   void testFunc(int i, std::string str) { t++; }
// };
//
...
//
//  std::string scriptPath = std::string(path) + "/lua_scripts/init.lua";
...
//  // lua_getglobal(L, "strikeWhall");
//
//  auto typeLua = lua_type(L, -1);
//  //  typeLua = lua_typename(L, 0);
//  //  typeLua = lua_typename(L, -2);
//  //  typeLua = lua_typename(L, 1);
//
//
...
//
//
//  lua_getfield(L, -1, "strikeWhall");
//
//  // typeLua = lua_typename(L, -1);
//  assert(lua_isfunction(L, -1));
//}
//
// void LuaClass::dostring(std::string_view code) { luaL_dostring(L, code.data()); }
//
